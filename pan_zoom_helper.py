...
class PAN_ZOOM_TOOL(QMainWindow):
    ...
    def load_ui(self):
        ...
        self.enable_pan_zoom_checkbox.stateChanged.connect(self.on_pan_zoom_enanble_changed)
    ...
    def on_pan_zoom_enanble_changed(self, state):
    ...
    def set_default_move_zoom_step(self):
        ...
        preferences_class = PREFERENCES()
        default_move_step_value = preferences_class.preferences.get('move_step_value')
        default_zoom_step_value = preferences_class.preferences.get('zoom_step_value')
